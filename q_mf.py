...
class Sel(unittest.TestCase):
	...
	def test_sel(self):
		...
		# 		print(topic)
		# 		# creating topic_dir where all excel sheets will be written
		# 		topic_dir = os.path.join(os.getcwd(), str(topic))
		...
		# 				df_questions_with_corresponding_links.to_excel(str(topic_dir)+"/"+str(topic)+"_links.xlsx")
